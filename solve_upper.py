...
In this file, we run the upper hierarchy until it stops having an optimility flag 
...
import re
import os
from gen_SDPA_upper import write_SDPA_pb_upper
...
def compute_hierarchy_upper(a):
    """
    Parameters
    ----------
    a : list
        Vector defining the witness sum_k a_k |k><k| for which
        It will compute an upper bound on the threshold value.
...
if __name__ == "__main__":
    a = [0,0.8,0.9,1.0]  # vector defining the witness sum_k a_k |k><k| for which
